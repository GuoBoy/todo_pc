<template>
  <div class="container">
    ...
    <el-form :model="userForm" ref="formRef" :rules="rules" label-width="70px">
      ...
      <el-form-item>
        <el-button type="primary" @click="onLogin()" style="width: 100%;">注册</el-button>
      </el-form-item>
      <router-link to="/login" style="position: absolute;right: 0;">已有账号？去登录</router-link>
    </el-form>
  </div>
</template>
